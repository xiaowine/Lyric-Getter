...
object Gramophone : BaseHook() {
    ...
    override fun init() {
        super.init()
        loadClass("androidx.core.app.NotificationManagerCompat", classLoader).methodFinder().first { name == "notify" }.createHook {
            after {
                ...
                if (isLyric) {
                    charSequence.isNotNull {
                        eventTools.sendLyric(charSequence.toString(), extra = ExtraData().apply {
